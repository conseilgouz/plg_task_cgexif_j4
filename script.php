<?php
/**
* Task CG EXIF Plugin  - Joomla 4.0.0 Plugin 
* Version			: 1.0.0
...
class plgtaskCGExifInstallerScript
{
	private $min_joomla_version      = '4.1.0';
	private $min_php_version         = '7.4';
	private $name                    = 'Plugin Task CGExif';
	private $exttype                 = 'plugin';
	private $extname                 = 'cgExif';
	private $previous_version        = '';
	private $dir           = null;
	private $installerName = 'plgtaskcgexifinstaller';
	...
	private function postinstall_cleanup() {
        ...
        try {
            ...
            JLog::add('unable to enable plugin cgexit', JLog::ERROR, 'jerror');
        }
	}
